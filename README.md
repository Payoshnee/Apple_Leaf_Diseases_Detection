...
Apply green channel extraction.
...
Fine-tune selected base-model layers.

Save the best-performing model.

Export training curves and evaluation metrics.
...
Payoshnee Parag JoshiB.Tech, Computer Science and EngineeringSpecialization in Cloud Computing and AutomationVIT Bhopal University
